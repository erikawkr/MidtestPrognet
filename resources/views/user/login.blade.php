    ...
    <div class="col-lg-4">
        <div class="card" style="width:30rem">
            ...
            <div class="card-body" style="height:20rem">
                <div class="row">
                    <div class="col-lg-6">
                        <form action="{{ route('login_proses') }}" class="form-group mt-3" style="padding-left:60px" method="post">
                            @csrf
                       ...
                       <div style="padding-left:60px">
                            <button type="submit" style="width:300px" class="btn btn-light"><a href="{{ route('register') }}">Register</a></button>
                       </div>
                    </div>
                     {{-- <div class="col-lg-3">
