...
<div class="container-fluid">
   ...
   <!-- DataTales Example -->
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{Route('keluhan.saveadd')}}" method="POST" class="">
                @csrf
                <div class="input-group row mt-3">
                    <label for="product rate" class="form-label col-3" style="padding-top:0.375rem;">Keluhan</label>
                    <textarea name="keluhan" class="form-control col-9 bg-light border-0 small" placeholder="Input Keluhan User..." rows="4"></textarea>
