...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{Route('admin.buku.saveadd')}}" method="POST" class="" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-group row mt-3">
                    ...
                    <input type="text" name="penerbit" class="form-control col-9 bg-light border-0 small" placeholder="Input Penerbit Buku...">
                </div>
                <div class="input-group row mt-3">
                    <label for="product rate" class="form-label col-3" style="padding-top:0.375rem;">Harga Buku</label>
                    <input type="number" name="harga" class="form-control col-9 bg-light border-0 small" placeholder="Input Harga Buku...">
                </div>
                <div class="input-group row mt-3">
